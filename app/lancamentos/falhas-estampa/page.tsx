...
const tiposFalhas = [
  { id: 1, nome: "Falha de Estampa", tipo: "estampa" },
  { id: 2, nome: "Cor Desbotada", tipo: "estampa" },
  { id: 3, nome: "Posicionamento Errado", tipo: "estampa" },
]

const falhasIniciais = [
  { id: 1, data: "2024-01-08", produto: "Camiseta Básica", tipoFalha: "Falha de Estampa", quantidade: 5 },
  { id: 2, data: "2024-01-08", produto: "Moletom", tipoFalha: "Cor Desbotada", quantidade: 3 },
  { id: 3, data: "2024-01-07", produto: "Vestido", tipoFalha: "Posicionamento Errado", quantidade: 2 },
]

export default function FalhasEstampaPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "A falha de estampa foi registrada com sucesso.",
    })
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Registro de Falhas de Estampa</h1>
        <p className="text-muted-foreground">Registre as falhas encontradas nas estampas</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Registre uma nova falha de estampa</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Últimas falhas de estampa registradas</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
